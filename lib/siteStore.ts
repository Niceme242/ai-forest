...
export const DEFAULT_ARTICLES: Article[] = [
  {
    ...
    src: 'https://images.unsplash.com/photo-1504701954957-2010ec3bcec1?w=800&h=500&fit=crop&crop=center',
  ...
  },
  {
    ...
    src: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800&h=500&fit=crop&crop=center',
    author: { name: 'Kofi Mensah', role: 'PDG & Co-Fondateur' },
  },
];

export const DEFAULT_TEAM: TeamMember[] = [
  { id: 1, name: 'Kofi Mensah', role: 'PDG & Co-Fondateur', description: "Agronome avec plus de 12 ans d'expérience terrain en Afrique Centrale et de l'Ouest. Convaincu que la technologie peut moderniser l'agriculture familiale.", src: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=400&h=400&fit=crop&crop=face' },
  { id: 2, name: 'Amina Diallo', role: 'Directrice Technique & IA', description: "Ingénieure en apprentissage automatique spécialisée dans les modèles de données agricoles. Ancienne chercheuse à l'Institut Africain des Sciences Mathématiques.", src: 'https://images.unsplash.com/photo-1607746882042-944635dfe10e?w=400&h=400&fit=crop&crop=face' },
  { id: 3, name: 'Jean-Pierre Nkosi', role: 'Responsable Produit', description: 'Designer produit et stratège UX spécialisé dans les outils adaptés aux environnements à faible connectivité, au service des communautés rurales.', src: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=400&fit=crop&crop=face' },
  { id: 4, name: 'Fatou Camara', role: 'Communauté & Croissance', description: "Spécialiste en vulgarisation agricole, elle fait le lien entre la technologie et les agriculteurs sur le terrain. Elle pilote l'accompagnement dans 6 pays.", src: 'https://images.unsplash.com/photo-1589156280159-27698a70f29e?w=400&h=400&fit=crop&crop=face' },
];
...
export const DEFAULT_GALLERY: GalleryImage[] = [
  { id: 1, title: 'Suivi des cultures', src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=640&h=420&fit=crop&crop=center' },
  { id: 2, title: 'Analyse des parcelles', src: 'https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?w=640&h=420&fit=crop&crop=center' },
  { id: 3, title: 'Travail de terrain', src: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=640&h=420&fit=crop&crop=center' },
  { id: 4, title: 'Récoltes locales', src: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=640&h=420&fit=crop&crop=center' },
];
...
export const DEFAULT_MONITORING_SETTINGS: MonitoringSettings = {
  ...
  stats_description:'',
  bg_image:         'https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?w=1920&h=1080&fit=crop&crop=center',
};

export const DEFAULT_FEATURES: Feature[] = [
  { id: 1, icon: 'SO', accent: 'Parcelles',  title: 'Analyse des sols',           description: "Comprenez la fertilité, l'eau et les besoins de chaque parcelle.", image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=400&h=300&fit=crop&crop=center', sort_order: 0 },
  { id: 2, icon: 'IA', accent: 'Cultures',   title: 'Recommandations IA',         description: 'Choisissez les bonnes cultures selon le climat, le sol et la saison.', image: 'https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?w=400&h=300&fit=crop&crop=center', sort_order: 1 },
  { id: 3, icon: 'MT', accent: 'Météo',      title: 'Alertes climatiques',        description: 'Anticipez pluie, chaleur, sécheresse et risques pour vos cultures.', image: 'https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?w=400&h=300&fit=crop&crop=center', sort_order: 2 },
  { id: 4, icon: 'RD', accent: 'Rendement',  title: 'Suivi des cultures',         description: 'Suivez la croissance, la santé et la performance agricole.', image: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=400&h=300&fit=crop&crop=center', sort_order: 3 },
  { id: 5, icon: 'AL', accent: 'Alertes',    title: 'Notifications intelligentes',description: "Recevez les bonnes actions au bon moment: irrigation, ravageurs, récolte.", image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=400&h=300&fit=crop&crop=center', sort_order: 4 },
  { id: 6, icon: 'RS', accent: 'Ressources', title: 'Optimisation des intrants',  description: "Réduisez le gaspillage d'eau, fertilisant et énergie.", image: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=300&fit=crop&crop=center', sort_order: 5 },
];
